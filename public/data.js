...
const SCHEDULE = [
  ...
  { day:'Domingo', tag:{label:'DESCANSO TOTAL', cls:'rest'}, rows:[
    ...
    {t:'10:00', type:'en',    title:'Repaso semanal de inglés',   note:'errores de la semana + 1 tema de gramática (Perfect English Grammar)'},
...
const TOOLS = [
  { name:'BBC Learning English', free:{label:'GRATIS', cls:'g'},
    fn:'Input estructurado por nivel (tu base)',
    when:'Transporte + 10 min en casa',
    how:'bbclearningenglish.com → menú "Courses". Empezá por el curso "Beginner" (A1, sem 1–2 para sacudir óxido), después vivís en "Lower-intermediate" (≈A2). En el bus: podcast "6 Minute English". Web + YouTube, sin cuenta.' },
  { name:'Anki', free:{label:'GRATIS', cls:'g'},
    fn:'Vocabulario (repetición espaciada)',
    when:'21:00, bloque de la noche · 15 min',
    how:'apps.ankiweb.net (gratis PC + Android; en iPhone usá la web). Bajá el mazo "NGSL / 1000 most common words", repasá lo pendiente y sumá 10 palabras nuevas que viste hoy.' },
  { name:'YouTube · canales', free:{label:'GRATIS', cls:'g'},
    fn:'Input por nivel (con imagen)',
    when:'Ocio viernes/sábado, en vez de scroll',
    how:'De fácil a difícil: Arnel’s Everyday English (A2, empezá acá) → Easy English → English with Lucy → Speak English With Vanessa → Learn English With TV Series. Tech (al llegar a B1): Fireship, freeCodeCamp, Web Dev Simplified.' },
  { name:'Podcasts', free:{label:'GRATIS', cls:'g'},
    fn:'Input para los oídos',
    when:'Transporte (los ~60 min en bus)',
    how:'A2–B1: 6 Minute English, Espresso English. B1+: Luke’s English Podcast, All Ears English. Descargalos la noche anterior para no depender de datos.' },
  { name:'IA conversacional', free:{label:'GRATIS', cls:'g'},
    fn:'Output sin pena (hablar) — tu cuello de botella',
    when:'21:00, bloque de output diario · 10–15 min',
    how:'Modo voz de Claude/ChatGPT: "háblame en inglés nivel A2 y corregí mis errores". Compañero de práctica 24/7, sin vergüenza. Tu prioridad #1.' },
  { name:'Language Reactor', free:{label:'GRATIS', cls:'g'},
    fn:'Leer escuchando (subtítulos dobles)',
    when:'Inmersión del mediodía o series de la noche',
    how:'Extensión de Chrome gratis. Pone subtítulos en inglés + español a la vez en YouTube y Netflix; tocás cualquier palabra para verla y guardarla. Reemplaza a LingQ.' },
  { name:'Perfect English Grammar', free:{label:'GRATIS', cls:'g'},
    fn:'Gramática + ejercicios',
    when:'Domingo, repaso semanal · ~45 min',
    how:'perfect-english-grammar.com (gratis, de Seonaid). 1 tema + ejercicios + revisás los errores que anotaste en la semana. Empezá por presente/pasado/futuro simple. Reemplaza al libro Murphy.' },
  { name:'Reverso Context', free:{label:'GRATIS', cls:'g'},
    ...
    how:'reverso.net — la ves en frases reales con traducción; guardá la que te sirva para una tarjeta de Anki.' },
  { name:'EF SET', free:{label:'GRATIS', cls:'g'},
    fn:'Medir tu nivel (CEFR)',
    when:'Ahora (diagnóstico) y al cierre de cada fase',
    how:'efset.org — test gratis de ~50 min que te da tu puntaje A2/B1/B2. Anotá el resultado: es tu prueba de que avanzás.' }
];
